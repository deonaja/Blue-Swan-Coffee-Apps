...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    List<Order> findByStatusNotAndCreatedAtBetween(OrderStatus status, java.time.LocalDateTime start, java.time.LocalDateTime end);
    ...
    List<Order> findSalesOrders(@org.springframework.data.repository.query.Param("statuses") List<OrderStatus> statuses, 
