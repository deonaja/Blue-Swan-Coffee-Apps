...
public class PaymentService {
    ...
    public Payment processPayment(UUID orderId) {
        ...
        // However, since database stores LocalDateTime without zone, we act as if it is in system zone.
        // For strict Jakarta, we assume the app runs in Jakarta or we treat stored time as Jakarta.
        ...
        // (or we just care about relative difference so checking current time in same zone is enough)
